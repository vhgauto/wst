...
El rango temporal del [script](https://code.earthengine.google.com/?noload=true&scriptPath=users%2Fvhgauto%2FGISTAQ%3AMati-Landsat) es entre 2013 y 2025, tomando únicamente el mosaico correspondiente a la fila 82 ($WRS\_ROW=82$). Se utilizó un vector alrededor del Embalse Río Tercero para recortar el producto y conservar únicamente la porción de interés. En total se descargaron <u>**`{r} length(l)`**</u> recortes.
